...
const sports = [
    {
        ...
        video: 'https://www.example.com/cricket.mp4',
        backgroundVideo: '/turf.mp4',
    },
    {
        name: 'Football',
    ...
    },
    {
        ...
        backgroundVideo: '/volleyball.mp4',
    },
]
...
export default function SportsOptions() {
    ...
    const handleVideoPlay = (videoUrl: SetStateAction<string>) => {
     ...
     const backgroundVideoSrc = useMemo(() => {
      ...
      const video = currentSport ? currentSport.backgroundVideo : "/turf.mp4";
      console.log("Background video:", video)
      return video;
    }, [selectedSport]);
    ...
    return (
        <section id="sports" className="relative py-24 bg-gray-50 overflow-hidden">
            {/* Background Video */}
             <video
                key={backgroundVideoSrc} // Added key attribute
                autoPlay
                loop
                muted
                    ...
                    {sports.map((sport) => (
                        ...
                        >
                            <Card className="border border-gray-200 hover:border-gray-300 transition-colors duration-300 backdrop-blur-sm bg-white/80">
                                ...
                                {showDate && formattedDueDate && <p>Due Date: {formattedDueDate}</p>}
